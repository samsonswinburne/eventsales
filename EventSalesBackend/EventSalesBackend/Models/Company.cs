...
public class Company
{
    ...
    [BsonElement("ownerId")] public required string OwnerId { get; set; }

    [BsonElement("admins")] public required List<string> Admins { get; set; } = new();

    [BsonElement("logo")] public required string LogoUrl { get; set; } = string.Empty;
    ...
    [BsonElement("postcode")] public required string PostCode { get; set; }
