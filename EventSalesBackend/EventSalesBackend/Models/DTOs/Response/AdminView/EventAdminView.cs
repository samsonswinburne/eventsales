...
namespace EventSalesBackend.Models.DTOs.Response.AdminView
{
    ...
    public class EventAdminView // event should be split up into in person event and digital event, in person event requires different things than digital event
    {
        ...
        public required List<TicketTypeAdminView> TicketTypes { get; set; } = new List<TicketTypeAdminView>();
